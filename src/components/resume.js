    ...
    return (
      <div className="page">
        <div className="resume-page">
          ...
          <div className="resume-title text-reveal">EXPERI<span className="grad-text">ENCE</span></div>

          <Reveal>
            <div className="exp-item card-3d" style={{borderRadius:0}}>
          ...
          <Reveal>
            <div style={{marginTop:'3rem'}}>
              ...
              <div className="resume-title">DEGR<span className="grad-text">EES</span></div>
              <div className="edu-row"><div><div className="edu-name">Br.S in Computer Science</div><div className="edu-school">CareerDevs Computer Science Institute — Providence, RI</div></div><div className="edu-year">2021</div></div>
              <div className="edu-row"><div><div className="edu-name">Bachelor of Arts in Business</div><div className="edu-school">Saint Anselm College — Manchester, NH</div></div><div className="edu-year">2014</div></div>
            </div>
          </Reveal>
          ...
          <Reveal>
            <div style={{marginTop:'3rem'}}>
              ...
              <div className="resume-title">SKI<span className="grad-text">LLS</span></div>
              <div className="skills-wrap">
                {skills.map((s,i) => <span className="skill-tag" key={s} style={{animationDelay:i*0.03+'s'}}><span>{s}</span></span>)}
              </div>
            </div>
          </Reveal>
        </div>
