...
import { RESUME_SKILLS } from '../data';
          ...
          <div style={{marginTop:'3rem'}}>
            ...
            <div className="skills-wrap">
              {RESUME_SKILLS.map((s, i) => (
                // CSS custom property drives the delay — avoids string concatenation per render.
                <span className="skill-tag" key={s} style={{'--skill-delay': `${i * 0.03}s`}}>
                  <span>{s}</span>
                </span>
              ))}
            </div>
